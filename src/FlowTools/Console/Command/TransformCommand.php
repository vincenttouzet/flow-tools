        ...
        $this->setName('transform')
            ...
            ->setDefinition(
                array(
                    ...
                    new InputArgument('columns', InputArgument::REQUIRED, 'The columns to export'),
...
<<<EOF
The <info>%command.name%</info> command transform a flow to another with columns selection.

For example to export a csv file into json:
    <info>php flow-tools %command.name% my_file.csv my_export.json my_column,another_column</info>
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $writer->close();
        $output->writeln(sprintf('%d entries exported', $nb));
    }
